            ...
            <div className="content bg-foterDiscount">
                <div className="all-contente max-w-xl mx-auto">
                    <div className="text-area py-20">
                        ...
                        <div className="search mx-8 flex justify-center items-center my-6 bg-slate-50">
                            ...
                            <button className="w-[30%] bg-[#ffbb38] md:py-4 font-sans md:text-md font-semibold py-1 text-[15px]">Get The Cupon</button>
                        </div>
                    </div>
                </div>
            </div>
