            ...
            <div className="logo-area w-[30%]">
                <div className="image-area">
                  ...
                  {/* mobile menu area start */}
                   <div className={`mobile-menu ${ catagoryHandeler ? "left-0 duration-300" :"left-[-400px] duration-300" }  bg-white w-[50%] shadow-xl absolute top-0 shadow-xl md:hidden z-50`}>
